...
author: "Sam Benning"
date: '2024-10-07'
categories: [football,offense,downs]
image: "image.png"
format: 
  html:
    code-fold: true
...
This is a post presenting the tempo of Big Ten Football teams from the 2023 and 2024 seasons. We will be exploring the number of plays called per game by each team to examine the clock stoppage rule changes across the NCAA.
